...
def get_data(cfg):
    ...
    if cfg.dataset.name == "all":
        ...
        imdbidlist_json, places_dict, acts_dict, casts_dict, auds_dict, annos_valid_dict= data_pre(cfg)

        partition = data_partition(cfg, imdbidlist_json, annos_valid_dict)  #数据划分
        #data_dict = {"annos_dict": annos_valid_dict, "casts_dict": casts_dict, "acts_dict": acts_dict}
        ...
        trainSet = Preprocessor(cfg, partition['train'], data_dict) #partition['train']就包括两个id
